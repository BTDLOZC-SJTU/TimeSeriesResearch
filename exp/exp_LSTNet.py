...
from models.LSTNet.LSTNet_network import LSTNet
...
class Exp_LSTNet(Exp_Basic):
    ...
    def _build_model(self):
        ...
        model = LSTNet(
            ...
            self.args.skip_cell_type,
            self.args.skip_hidden_size,
            self.args.skip_num_layers,
            self.args.skip_size,
            self.args.ar_window,
